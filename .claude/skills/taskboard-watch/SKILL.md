...
- **Interval**: default 10 minutes unless told otherwise. Tighter intervals near a stated briefing time are reasonable if the user seems anxious about it; there's no reason to go below ~5 minutes for a page a human would refresh by hand.
